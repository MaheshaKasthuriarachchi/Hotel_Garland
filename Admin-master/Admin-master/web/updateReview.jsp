                    ...
                    <div class="container-fluid">
                        <div class="box-widget widget-module">
                            ...
                            <%
                                ...
                                pojo.AnalyticReview ee = (pojo.AnalyticReview) ses.load(pojo.AnalyticReview.class, (Integer.parseInt(revID)));
                                hs.setAttribute("updatereviewid", ee);
                            %>
                            <div class="widget-container">
                                <div class=" widget-block">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-8">
                                            <input id="reviewid" type="text" value=" <%= ee.getReviewId()%>" class="form-control date-mask" disabled=""/>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-4 control-label">Review Month</label>
                                        <div class="col-md-8">
                                            <input id="reviewmonth" type="text" value=" <%= ee.getMonth()%>" class="form-control date-mask" disabled=""/>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-4 control-label">Review</label>
                                        <div class="col-md-8">
                                            <input id="review" type="text" value=" <%= ee.getReview()%>" class="form-control date-mask"/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-8">
                                            <center>
                                                <button  id="update" class="btn btn-success btn-block" onclick="updateReview()"><i class="icon-play"></i>Update Review</button>	
                                                <button  id="delete" class="btn btn-danger btn-block" onclick="deleteReview()"><i class="icon-play"></i>Delete Review </button>	
            ...
            function deleteReview() {
                ...
                yewxmlhttp.onreadystatechange = function() {
                    ...
                    if (yewxmlhttp.readyState == 4 && yewxmlhttp.status == 200) {
                        ...
                        if (gett === "ok") {
                            //   alert("inside if");
                            swal("Done!", "Successfully deleted the review!", "success");
                            window.location = "Analytics.jsp";
                ...
                yewxmlhttp.open("POST", "deleteReview", true);
                yewxmlhttp.setRequestHeader('Content-Type', 'application/x-www-form-urlencoded');
