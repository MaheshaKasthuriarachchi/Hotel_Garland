...
<html>
    ...
    <body>
                    ...
                    <div class="container-fluid">
                        <div class="box-widget widget-module">
                            ...
                            <%
                                ...
                                pojo.ReserveTable ee = (pojo.ReserveTable) ses.load(pojo.ReserveTable.class, (Integer.parseInt(TableId)));
                                hs.setAttribute("updatetableid", ee);
                            %>
                            <div class="widget-container">
                                <div class=" widget-block">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-8">
                                            <input id="reservedate" type="text" value=" <%= ee.getReserveDate()%>" class="form-control date-mask" />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-4 control-label">Time Slot</label>
                                        <div class="col-md-8">
                                            <input id="timeslot" type="text" value=" <%= ee.getTime()%>" class="form-control date-mask" />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-4 control-label">Table Count</label>
                                        <div class="col-md-8">
                                            <input id="tablecount" type="text" value=" <%= ee.getTableCount()%>" class="form-control date-mask"/>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-4 control-label">Reserved Table Numbers</label>
                                        <div class="col-md-8">
                                            <input id="restablenum" type="text" value=" <%= ee.getReservedTables()%>" class="form-control date-mask" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-8">
                                            <center>
                                                <button  id="update" class="btn btn-success btn-block" onclick="updateTableReservation()"><i class="icon-play"></i>Update Table Reservation</button>	
                                                <button  id="delete" class="btn btn-danger btn-block" onclick="deleteTableReservation()"><i class="icon-play"></i>Delete Table Reservation </button>	
        ...
        <script>
            function updateTableReservation() {
                ...
                var ResTableNum = document.getElementById("restablenum").value;

                    yewxmlhttp.open("POST", "updateTableReservation", true);
                    yewxmlhttp.setRequestHeader('Content-Type', 'application/x-www-form-urlencoded');
                    yewxmlhttp.send("reservedate="+ReserveDate+"&timeslot="+TimeSlot+"&tablecount="+TableCount+
        ...
        <script>
            ...
            function deleteTableReservation() {
                ...
                yewxmlhttp.open("POST", "deleteTableReservation", true);
                yewxmlhttp.setRequestHeader('Content-Type', 'application/x-www-form-urlencoded');
