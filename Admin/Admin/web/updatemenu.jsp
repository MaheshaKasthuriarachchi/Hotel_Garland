                    ...
                    <div class="container-fluid">
                        <div class="box-widget widget-module">
                            ...
                            <%
                                ...
                                hs.setAttribute("updatemenuid", menu);
                            %>
                            <div class="widget-container">
                                <div class=" widget-block">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-8">
                                            <input id="empname" type="text" value=" <%= menu.getFoodName()%>" class="form-control date-mask" disabled=""/>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-4 control-label">Menu Type</label>
                                        <div class="col-md-8">
                                            <input id="empaddress" type="text" value=" <%= menu.getMenuType()%>" class="form-control date-mask" disabled=""/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-8">
                                            <input id="menuunitp" type="text" value=" <%= menu.getPrice()%>" class="form-control date_time-mask"/>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-4 control-label">Portion Details</label>
                                        <div class="col-md-8">
                                            <input id="pdetails" type="text" value=" <%= menu.getPortionSize()%>" class="form-control date_time-mask"/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-8">
                                            <center>
                                                <button  id="updatemyn" class="btn btn-success btn-block" onclick="updateMenu()"><i class="icon-play"></i>Update Menu Details</button>	
                                                <button  id="updatemyn" class="btn btn-danger btn-block" onclick="deleteMenu()"><i class="icon-play"></i>Delete Menu </button>	
            ...
            function updateMenu() {
                ...
                yewxmlhttp.onreadystatechange = function() {
                    ...
                    if (yewxmlhttp.readyState == 4 && yewxmlhttp.status == 200) {
                        ...
                        if (gett === "ok") {
                            //   alert("inside if");
                            swal("Done!", "Menu Details Successfully Updated..!", "success");
                            window.location = "addnewMenu.jsp";
                ...
                if (unitprice == "" && PDetails == "") {
                    ...
                    yewxmlhttp.send("untp=" + unitprice+"&pdetails="+PDetails);
                }
